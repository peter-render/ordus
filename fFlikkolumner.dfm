  ...
  object qryGridcolumns: TFDQuery
    ...
    SQL.Strings = (
      'select '
        ...
        'Id, Fieldname, DisplayWidth, FieldHeader,Status6,Status5, Status' +
        '4, Status3, Status2, Status1, Ordning'
      'FROM GridColumns')
    Left = 424
    Top = 212
    ...
    object qryGridcolumnsStatus6: TBooleanField
      DisplayLabel = '     Arkiv'
      DisplayWidth = 8
      FieldName = 'Status6'
      Origin = 'Status6'
