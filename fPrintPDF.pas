...
uses
  ...
  FireDAC.Comp.Client, gtScrollingPanel, gtPDFViewer, gtPDFClasses, gtCstPDFDoc,
  gtExPDFDoc, gtExProPDFDoc, gtPDFDoc,
  gtPDFPrinter, Vcl.Menus;
...
begin
  ...
  PDFFilepathName := ftgsystemvalue('pdf.folder','c:\temp');
