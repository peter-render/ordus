...
uses
  ...
  Vcl.wwdbigrd, Vcl.wwdbgrid, Vcl.Buttons, Vcl.Mask, Vcl.DBCtrls, EditNew;
...
type
  TfrmOrderkalkyl = class(TForm)
    ...
    edtLeveransdatum: TDateTimePicker;
...
procedure TfrmOrderkalkyl.tblOrderkalkylArtikelNewRecord(DataSet: TDataSet);
begin
  DataSet.FieldByName('Artikelnummer').AsString := qryLU_Artikel.FieldByName('Artikelnummer').AsString;
end;

procedure TfrmOrderkalkyl.wwDBGrid3RowChanged(Sender: TObject);
begin
...
procedure TfrmOrderkalkyl.wwDBLookupCombo2CloseUp(Sender: TObject; LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TfrmOrderkalkyl.wwDBLookupCombo3CloseUp(Sender: TObject; LookupTable, FillTable: TDataSet; modified: Boolean);
begin
