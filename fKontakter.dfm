  ...
  object Panel1: TPanel
    ...
    object Panel4: TPanel
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Height = 599
        Selected.Strings = (
          'Kundnamn'#9'23'#9'Kund'
          'Akt'#246'rnamn'#9'20'#9'Akt'#246'r'
          'emailadress'#9'29'#9'Epostadress'
          'Telefonnummer'#9'22'#9'Telefonnummer'
          'Mobilnummer'#9'20'#9'Mobilnummer')
        ...
        Options = [dgTitles, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgConfirmDelete, dgCancelOnExit, dgWordWrap, dgPerfectRowFit, dgMultiSelect]
        ParentFont = False
        ReadOnly = True
        TabOrder = 0
