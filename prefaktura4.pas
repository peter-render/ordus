...
{                                                    XML Data Binding                                                    }
{                                                                                                                        }
{         Generated on: 2018-10-25 20:43:36                                                                              }
...
{ IXMLINVOIC416Type }
  ...
  IXMLINVOIC416Type = interface(IXMLNode)
    ['{DA722D93-0EC9-4942-B1EF-C2467B493C98}']
    { Property Accessors }
...
{ IXMLInvoiceType }
  ...
  IXMLInvoiceType = interface(IXMLNode)
    ['{512558DA-08D2-48CE-A769-E637AA7A3CF0}']
    { Property Accessors }
...
{ IXMLHeadType }
  ...
  IXMLHeadType = interface(IXMLNode)
    ['{03284DC9-F399-46A8-97C5-47AC8B9FB50B}']
    { Property Accessors }
    ...
    function Get_AlloyCost: UnicodeString;
    function Get_FreightCost: UnicodeString;
    function Get_PackingCost: UnicodeString;
    function Get_InsuranceCost: UnicodeString;
    function Get_NetAmountInInvoiceCurrency: UnicodeString;
    function Get_InvoicingCharge: UnicodeString;
    ...
    procedure Set_AlloyCost(Value: UnicodeString);
    procedure Set_FreightCost(Value: UnicodeString);
    procedure Set_PackingCost(Value: UnicodeString);
    procedure Set_InsuranceCost(Value: UnicodeString);
    procedure Set_NetAmountInInvoiceCurrency(Value: UnicodeString);
    procedure Set_InvoicingCharge(Value: UnicodeString);
    ...
    property AlloyCost: UnicodeString read Get_AlloyCost write Set_AlloyCost;
    property FreightCost: UnicodeString read Get_FreightCost write Set_FreightCost;
    property PackingCost: UnicodeString read Get_PackingCost write Set_PackingCost;
    property InsuranceCost: UnicodeString read Get_InsuranceCost write Set_InsuranceCost;
    ...
    property InvoicingCharge: UnicodeString read Get_InvoicingCharge write Set_InvoicingCharge;
...
{ IXMLBuyerType }
  ...
  IXMLBuyerType = interface(IXMLNode)
    ['{85CFE8E9-959D-4ED8-BABF-ED0CA7712C5A}']
    { Property Accessors }
...
{ IXMLInvoiceAddressType }
  ...
  IXMLInvoiceAddressType = interface(IXMLNode)
    ['{1D1D74E2-2CA5-46CE-8E54-733D9F575119}']
    { Property Accessors }
...
{ IXMLDeliveryAddressType }
  ...
  IXMLDeliveryAddressType = interface(IXMLNode)
    ['{F8E91AC6-6055-4BD2-96B7-4A87AE185E52}']
    { Property Accessors }
...
{ IXMLSellerType }
  ...
  IXMLSellerType = interface(IXMLNode)
    ['{430FD06C-41C9-4896-96F2-44480EB173FD}']
    { Property Accessors }
...
{ IXMLPostalAddressType }
  ...
  IXMLPostalAddressType = interface(IXMLNode)
    ['{C9591E33-B3A3-47B6-BE9B-047EA3615AD9}']
    { Property Accessors }
...
{ IXMLVisitingAddressType }
  ...
  IXMLVisitingAddressType = interface(IXMLNode)
    ['{87EA9E35-41FE-4A59-A898-A23C84F65A7E}']
    { Property Accessors }
...
{ IXMLFactoringType }
  ...
  IXMLFactoringType = interface(IXMLNode)
    ['{8F22FD77-D9F2-4208-8F9F-93A071DDF8ED}']
    { Property Accessors }
...
{ IXMLRowsType }
  ...
  IXMLRowsType = interface(IXMLNodeCollection)
    ['{2779C2AE-62AA-481E-9AE3-F0F0A0016938}']
    { Property Accessors }
...
{ IXMLRowType }
  ...
  IXMLRowType = interface(IXMLNode)
    ['{24F8F702-7387-433E-8F40-48F105FB1833}']
    { Property Accessors }
    function Get_RowNumber: Integer;
    function Get_RowType: UnicodeString;
    function Get_RowPosition: UnicodeString;
    ...
    function Get_Quantity: UnicodeString;
    ...
    function Get_RowSum: UnicodeString;
    function Get_BuyersOrderNumber: unicodeString;
    function Get_SellersOrderNumber: unicodeString;
    ...
    procedure Set_RowPosition(Value: UnicodeString);
    ...
    procedure Set_Quantity(Value: UnicodeString);
    ...
    procedure Set_RowSum(Value: UnicodeString);
    procedure Set_BuyersOrderNumber(Value: unicodeString);
    procedure Set_SellersOrderNumber(Value: unicodeString);
    ...
    property RowPosition: UnicodeString read Get_RowPosition write Set_RowPosition;
    ...
    property Quantity: UnicodeString read Get_Quantity write Set_Quantity;
    ...
    property RowSum: UnicodeString read Get_RowSum write Set_RowSum;
    property BuyersOrderNumber: unicodeString read Get_BuyersOrderNumber write Set_BuyersOrderNumber;
    property SellersOrderNumber: unicodeString read Get_SellersOrderNumber write Set_SellersOrderNumber;
...
function TXMLHeadType.Get_AlloyCost: UnicodeString;
begin
  Result := ChildNodes['AlloyCost'].NodeValue;
end;

procedure TXMLHeadType.Set_AlloyCost(Value: UnicodeString);
begin
  ChildNodes['AlloyCost'].NodeValue := Value;
end;

function TXMLHeadType.Get_FreightCost: UnicodeString;
begin
  Result := ChildNodes['FreightCost'].NodeValue;
end;

procedure TXMLHeadType.Set_FreightCost(Value: UnicodeString);
begin
  ChildNodes['FreightCost'].NodeValue := Value;
end;

function TXMLHeadType.Get_PackingCost: UnicodeString;
begin
  Result := ChildNodes['PackingCost'].NodeValue;
end;

procedure TXMLHeadType.Set_PackingCost(Value: UnicodeString);
begin
  ChildNodes['PackingCost'].NodeValue := Value;
end;

function TXMLHeadType.Get_InsuranceCost: UnicodeString;
begin
  Result := ChildNodes['InsuranceCost'].NodeValue;
end;

procedure TXMLHeadType.Set_InsuranceCost(Value: UnicodeString);
begin
...
function TXMLHeadType.Get_InvoicingCharge: UnicodeString;
begin
  Result := ChildNodes['InvoicingCharge'].NodeValue;
end;

procedure TXMLHeadType.Set_InvoicingCharge(Value: UnicodeString);
begin
...
function TXMLRowType.Get_RowPosition: UnicodeString;
begin
  Result := AttributeNodes['RowPosition'].NodeValue;
end;

procedure TXMLRowType.Set_RowPosition(Value: UnicodeString);
begin
...
function TXMLRowType.Get_Quantity: UnicodeString;
begin
  Result := ChildNodes['Quantity'].NodeValue;
end;

procedure TXMLRowType.Set_Quantity(Value: UnicodeString);
begin
...
function TXMLRowType.Get_Price: UnicodeString;
begin
  Result := ChildNodes['Price'].NodeValue;
end;

procedure TXMLRowType.Set_Price(Value: UnicodeString);
begin
...
function TXMLRowType.Get_RowSum: UnicodeString;
begin
  Result := ChildNodes['RowSum'].NodeValue;
end;

procedure TXMLRowType.Set_RowSum(Value: UnicodeString);
begin
