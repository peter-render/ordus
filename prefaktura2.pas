...
{                                                    XML Data Binding                                                    }
{                                                                                                                        }
{         Generated on: 2018-10-23 21:41:33                                                                              }
...
{ IXMLINVOIC416Type }
  ...
  IXMLINVOIC416Type = interface(IXMLNode)
    ['{51DE7E8E-98B1-4F8E-A854-90EAD5FB562A}']
    { Property Accessors }
...
{ IXMLInvoiceType }
  ...
  IXMLInvoiceType = interface(IXMLNode)
    ['{965FB585-2A55-4C80-830E-D7D23DB0660B}']
    { Property Accessors }
...
{ IXMLHeadType }
  ...
  IXMLHeadType = interface(IXMLNode)
    ['{E8290B3A-D62E-4BAA-B478-E5F85747C56C}']
    { Property Accessors }
...
{ IXMLBuyerType }
  ...
  IXMLBuyerType = interface(IXMLNode)
    ['{FDB9B84C-C359-48D8-86DC-36358B1A9F63}']
    { Property Accessors }
...
{ IXMLInvoiceAddressType }
  ...
  IXMLInvoiceAddressType = interface(IXMLNode)
    ['{11DC2CF9-7762-4EE8-A5C0-CAF2789366EE}']
    { Property Accessors }
...
{ IXMLDeliveryAddressType }
  ...
  IXMLDeliveryAddressType = interface(IXMLNode)
    ['{947F770B-86B0-4248-988B-977509AFB8E9}']
    { Property Accessors }
...
{ IXMLSellerType }
  ...
  IXMLSellerType = interface(IXMLNode)
    ['{D951439A-BCFC-4181-9830-3786B6DD70AB}']
    { Property Accessors }
...
{ IXMLPostalAddressType }
  ...
  IXMLPostalAddressType = interface(IXMLNode)
    ['{F9A99C40-F08D-4CC7-AC07-C5296168CEDD}']
    { Property Accessors }
...
{ IXMLVisitingAddressType }
  ...
  IXMLVisitingAddressType = interface(IXMLNode)
    ['{1CEA7C23-04F5-4408-B6E4-184C7A7BC80D}']
    { Property Accessors }
...
{ IXMLFactoringType }
  ...
  IXMLFactoringType = interface(IXMLNode)
    ['{0035CEAF-F21C-4422-BFB4-144F71E8997F}']
    { Property Accessors }
...
{ IXMLRowsType }
  ...
  IXMLRowsType = interface(IXMLNodeCollection)
    ['{88416248-337A-489B-AC2F-8E6C55AF407B}']
    { Property Accessors }
...
{ IXMLRowType }
  ...
  IXMLRowType = interface(IXMLNode)
    ['{995B498B-A5E4-4567-87E1-A233568EE192}']
    { Property Accessors }
...
function TXMLINVOIC416Type.Get_SoftwareName: string;
begin
  Result := AttributeNodes['SoftwareName'].Text;
end;

procedure TXMLINVOIC416Type.Set_SoftwareName(Value: string);
begin
  SetAttribute('SoftwareName', Value);
end;

function TXMLINVOIC416Type.Get_SoftwareVersion: string;
begin
  Result := AttributeNodes['SoftwareVersion'].Text;
end;

procedure TXMLINVOIC416Type.Set_SoftwareVersion(Value: string);
begin
...
function TXMLHeadType.Get_OrderDate: string;
begin
  Result := ChildNodes['OrderDate'].Text;
end;

procedure TXMLHeadType.Set_OrderDate(Value: string);
begin
...
function TXMLHeadType.Get_InvoiceDate: string;
begin
  Result := ChildNodes['InvoiceDate'].Text;
end;

procedure TXMLHeadType.Set_InvoiceDate(Value: string);
begin
  ChildNodes['InvoiceDate'].NodeValue := Value;
end;

function TXMLHeadType.Get_LanguageNameCode: string;
begin
  Result := ChildNodes['LanguageNameCode'].Text;
end;

procedure TXMLHeadType.Set_LanguageNameCode(Value: string);
begin
