inherited frmKunder: TfrmKunder
  ...
  inherited FDQuery1: TFDQuery
    ...
    SQL.Strings = (
      ...
      #9'Id Kundnr '
      #9',Kundnamn'
      #9',Oms'#228'ttningInnevarande'#197'r  ='
      #9#9'('
      ...
      #9#9#9#9#9#9'join akt'#246'r a on a.id = kp.Id'
      #9#9#9#9#9#9'where kp.Kundid = k.Id '
      #9#9#9#9#9#9'--and a.Aktiv = 1'
      #9#9#9#9#9#9'and kp.borttagen is null )'
      ''
      ',k.Marginalprocent '
