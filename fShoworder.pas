...
type
  TfrmShowOrder = class(TForm)
    ...
    FDQuery3PrisperEnhet: TCurrencyField;
    FDQuery3Antal: TFMTBCDField;
    FDQuery3Kortdatum: TStringField;
    FDQuery3YtbehandlingBeteckning: TStringField;
    FDQuery3OrderID: TFDAutoIncField;
    FDQuery3OrdertypId: TIntegerField;
    ...
    procedure wwDBGrid2CalcCellColors(Sender: TObject; Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
      ABrush: TBrush);
  private
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        label1.caption := 'Sök artikelnummer';
      end
...
procedure TfrmShowOrder.wwDBGrid2CalcCellColors(Sender: TObject; Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
if fdquery3.FieldByName('OrdertypId').AsInteger = 3 then
afont.Color:= clRed;
