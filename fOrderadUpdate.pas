...
type
  ...
  TfrmOrderradUpdate = class(TForm)
    ...
    qryOrderradÖvrigt1: TCurrencyField;
    qryOrderradÖvrigt2: TCurrencyField;
...
begin
  if (DataSet.FieldByName('PrisperenhetAuto').AsFloat <> 0) or (DataSet.FieldByName('Övrigt1').AsFloat <> 0) or
    (DataSet.FieldByName('Övrigt2').AsFloat <> 0) then
    DataSet.FieldByName('SummaAuto').value := DataSet.FieldByName('PrisperenhetAuto').AsFloat +
      DataSet.FieldByName('Övrigt1').AsFloat + DataSet.FieldByName('Övrigt2').AsFloat;
