...
procedure TfrmOrderradUpdate.wwDBGrid1MouseDown(Sender: TObject;
...
begin
  ...
  begin
    ...
    try
      ...
      if dbg.Columns[col].fieldname = 'SenastePrisPerEnhet' then
      begin
...
begin
  ...
  if ((Field.fieldname = 'SenastePrisPerEnhet') or (Field.fieldname = 'SenasteOrderdatum'))    and (qryOrderrad.FieldbyName('SenasteOrdertypId').asInteger = 3) then
    AFont.Color := clRed;
