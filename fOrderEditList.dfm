object frmOrderEditList: TfrmOrderEditList
  ...
  object Panel3: TPanel
    ...
    object wwDBGrid1: TwwDBGrid
      ...
      Height = 435
      ControlType.Strings = (
        'YBBeteckning;CustomEdit;wwDBLookupCombo1;F'
        'YtbehandlingId;CustomEdit;wwDBLookupCombo1;T')
      Selected.Strings = (
        'ID'#9'24'#9'ID'#9#9
  ...
  object qryOrderrad: TFDQuery
    ...
    object qryOrderradYBBeteckning: TStringField
      DisplayWidth = 39
      FieldName = 'YBBeteckning'
      Origin = 'YBBeteckning'
      Visible = False
      OnChange = qryOrderradYBBeteckningChange
      Size = 50
    end
  end
